...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String Answer= JOptionPane.showInputDialog("Enter in a positive number");
